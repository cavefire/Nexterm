...
const CollapsibleFolder = ({ id, name, entries, nestedLevel, renameState, setRenameStateId, connectToServer, openNotes, activeNotesEntryId, organizationId, folderType, hibernatedSessions = [] }) => {
        ...
        <>
            ...
            {isOpen && (
                <ServerEntries entries={entries} nestedLevel={nestedLevel + 1} setRenameStateId={setRenameStateId} folderId={id}
                    organizationId={organizationId} connectToServer={connectToServer} openNotes={openNotes} activeNotesEntryId={activeNotesEntryId}
